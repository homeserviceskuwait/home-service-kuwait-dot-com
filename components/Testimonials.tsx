...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="reviews" className="py-24 bg-white dark:bg-slate-950 overflow-hidden relative transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {content.list.map((testimonial) => (
            <div key={testimonial.id} className="group relative bg-slate-50 dark:bg-slate-900 p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/30 hover:-translate-y-1">
              {/* Giant Quote Mark */}
