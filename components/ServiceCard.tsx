...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="group relative bg-white dark:bg-slate-900 rounded-3xl p-2 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
    >
      ...
      <div className="relative z-10 p-6 flex flex-col h-full border border-slate-100 dark:border-slate-800 rounded-2xl bg-slate-50/50 dark:bg-slate-800/50 group-hover:bg-white dark:group-hover:bg-slate-800 group-hover:border-transparent transition-colors">

        {/* Icon & Image Header */}
        <div className="flex justify-between items-start mb-6">
          <div className="w-12 h-12 bg-teal-100 dark:bg-teal-900/50 rounded-2xl flex items-center justify-center text-teal-700 dark:text-teal-400 group-hover:scale-110 transition-transform duration-300">
