  ...
  return (
    <div className={`min-h-screen bg-white dark:bg-slate-950 font-sans text-slate-900 dark:text-white overflow-x-hidden transition-colors duration-300 ${isRTL ? 'font-arabic' : 'font-sans'}`}>
      ...
      <main>
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {content.whyUs.list.map((feature, idx) => {
                        ...
                        return (
                          <div key={idx} className="bg-slate-50 dark:bg-slate-900 p-8 rounded-[2rem] hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/30 transition-all duration-300 group border border-slate-100 dark:border-slate-800">
                              <div className="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-teal-600 group-hover:text-white transition-colors">
                                  <Icon className="h-7 w-7 text-teal-600 dark:text-teal-400 group-hover:text-white transition-colors" />
                              </div>
        ...
        {/* Services Section */}
        <section id="services" className="py-24 bg-slate-50/50 dark:bg-slate-900/50 transition-colors duration-300">
          <div className="container mx-auto px-4">
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {content.blog.list.map((post) => (
                        <article key={post.id} className="group cursor-pointer bg-white dark:bg-slate-900 rounded-3xl p-3 hover:shadow-xl hover:shadow-slate-200/50 dark:hover:shadow-black/30 transition-all duration-300">
        ...
        <section id="contact" className="py-24 bg-slate-900 dark:bg-slate-950 relative overflow-hidden transition-colors duration-300">
